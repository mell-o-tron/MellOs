...
#define HEAP_PHYS_START 0x800000
#define HEAP_PHYS_END 0xBFFFFF
#define KERNEL_HEAP_PHYS_START 0xC00000
#define KERNEL_HEAP_PHYS_END 0xcFFFFFF

#define HEAP_SIZE (HEAP_PHYS_END - HEAP_PHYS_START)
#define KERNEL_HEAP_SIZE (KERNEL_HEAP_PHYS_END - KERNEL_HEAP_PHYS_START)

#define HEAP_VIRT_START 0xC0400000
#define HEAP_VIRT_END (HEAP_VIRT_START + (HEAP_PHYS_END - HEAP_PHYS_START))
#define KERNEL_HEAP_VIRT_START 0xC0800000
#define KERNEL_HEAP_VIRT_END (KERNEL_HEAP_VIRT_START + (KERNEL_HEAP_PHYS_END - KERNEL_HEAP_PHYS_START))

#define HEAP_4MB_PAGES (ALIGN_UP(HEAP_SIZE, 0x400000) / 0x400000)
#define KERNEL_HEAP_4MB_PAGES (ALIGN_UP(KERNEL_HEAP_SIZE, 0x400000) / 0x400000)
