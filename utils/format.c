...
/* Write one character to a buffer, dest and dsize are adjusted after the operation */
...
/* Write several characters to a buffer, dest and dsize are adjusted after the operation */
